...
\newglossaryentry{paneltwinX}
{
	...
	description={Módulo de la aplicación que permite añadir información a bajo nivel (al \gls{superusuario}), como las universidades, los países o los emails predefinidos.}
}
