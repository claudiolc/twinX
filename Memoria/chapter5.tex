...
\begin{table}[h]
	\begin{center}
		\begin{tabular}{ | c | c | c | } 
			\hline
			\textbf{Identificación} & \parbox[t]{7cm}{HU2 - Gestionar el trabajo diario de la oficina: estudiantes, expedientes, acuerdos de estudios, convenios y tutores.}  & \textbf{Sprint:} 1 \\
			\hline
...
\begin{table}[h]
	\begin{center}
		\begin{tabular}{ | c | c | c | } 
			\hline
			\textbf{Identificación} & \parbox[t]{7cm}{HU3.1 - Crear nuevos eventos con tareas asociadas a los mismos.}  & \textbf{Sprint:} 2 \\
			\hline
