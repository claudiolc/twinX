...
\begin{figure}
	\includegraphics[width=\textwidth]{img/Capturas de TWINS/login}
...
\begin{itemize}
	...
	\item La pantalla de avisos nos alerta de las acciones que tenemos que realizar con mayor urgencia, dado que han sido programadas para tenerlas listas para una fecha cercana y necesitan de la atención del usuario al que se notifica
	 ...
	 \begin{figure}
	 	\includegraphics[width=\textwidth]{"img/Capturas de TWINS/avisos"}
	 ...
	 %MISMA PANTALLA QUE LA ANTERIOR
	...
	%AQUÍ VA LA PANTALLA DE EVENTOS SIN PROCESAR
	
\end{itemize}

Finalmente, llegamos a la pantalla principal, de donde parten todos los menús (incluso los que acabamos de ver, que se muestran automáticamente identificarse correctamente en el sistema).
...
Las siguientes vistas se proporcionan como ejemplo de lo mencionado, aunque no comentemos sus aspectos específicos, dado que la metodología empleada para su creación es la misma que ya hemos expuesto y la interacción por parte del usuario es similar:
